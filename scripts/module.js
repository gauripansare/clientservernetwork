...
var _ModuleCommon = (function () {
    ...
    return {
        ...
        DisplayUserReviewMode: function () {
            if (_Navigator.GetCurrentPage().pageId == "p9") {
        ...
        SetAccessibility: function () {
            ...
            if ($("#" + radio).hasClass("correct")) {
                ...
                $("input[type='radio'].correct").attr("aria-label", "Correct option " + $("input[type='radio'].correct").next("label").text());
                $("input[type='radio'].correct").next("label").attr("aria-hidden", "true");
                //var ar_label = "Correct option selected" + $("input[type='radio'].correct") + $("#" + radio).next("label").text();
        ...
        OnSubmit: function () {
            ...
            if ($("input[type='radio']:checked").attr("id") == pageData.radio) {
                ...
                if (this.CalculateScore() == 2 || _Navigator.GetCounter() > 1) {
        ...
        AddReviewData: function (isCorrect, fdkurl) {
            ...
            else if (currentPageData.pageId == "p9") {
                var obj = {};
